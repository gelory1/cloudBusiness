  ...
  <div class="address">
    <div :style="{background: '#fff', padding: '10px', borderRadius: '5px'}">
      ...
      <Form ref="filterItem" :model="filterItem" :label-width="80">
        ...
        <FormItem label="合作伙伴" prop="hzhb">
          <Row>
            <Col :span="12">
              <Select v-model="filterItem.hzhb" clearable filterable multiple>
                <Option :value="item.index" v-for="(item,index) in status" :key="index">{{item.val}}</Option>
              </Select>
            </Col>
          </Row>
    ...
    >
      ...
      >
        ...
        <el-table-column label="存货编码" align="right" header-align="left">
          <template slot-scope="scope">
            <span style="color:#0099FF">总计：</span>
          </template>
        </el-table-column>
        <el-table-column property="contractNature" label="备货数量"></el-table-column>
        <el-table-column property="contractNature1" label="备货金额（元）"></el-table-column>
        <el-table-column property="contractNature2" label="已安装数量"></el-table-column>
        <el-table-column property="contractNature3" label="已安装金额（元）"></el-table-column>
        <el-table-column property="contractNature4" label="已结算数量"></el-table-column>
        <el-table-column property="contractNature5" label="未安装数量"></el-table-column>
        <el-table-column property="contractNature6" label="未结算数量"></el-table-column>
        <el-table-column property="contractNature7" label="未结算金额（元）"></el-table-column>
      </el-table>
      <el-table
        ref="table"
        :show-header="false"
      ...
      >
        ...
        <el-table-column property="contractNature" label="产品型号"></el-table-column>
        <el-table-column property="contractNature1" label="存货编码"></el-table-column>
        <el-table-column property="contractNature2" label="备货数量"></el-table-column>
        <el-table-column property="contractNature3" label="备货金额（元）"></el-table-column>
        <el-table-column property="contractNature4" label="已安装数量"></el-table-column>
        <el-table-column property="contractNature5" label="已安装金额（元）"></el-table-column>
        <el-table-column property="contractNature6" label="已结算数量"></el-table-column>
        <el-table-column property="contractNature7" label="未安装数量"></el-table-column>
        <el-table-column property="contractNature8" label="未结算数量"></el-table-column>
        <el-table-column property="contractNature9" label="未结算金额（元）"></el-table-column>
      </el-table>
      <Page
        :total="sum"
